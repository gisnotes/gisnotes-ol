import{_ as E,r as s,A as h,I as S,af as j,ag as x,J as A,o as R,m as I,f as P,P as w,h as O,U as L,i as u,K as G}from"./index-jD_X0PT8.js";import{M,V as k,D as B,u as C}from"./Source-BfaDjW3k.js";import{I as K,G as D,M as U,W as m}from"./index-DO2IC-mw.js";import{X as Y}from"./XYZ-6ZxMT48g.js";import"./index-CwDaKGgQ.js";import"./TileImage-Bd0ar7pU.js";import"./proj4-ChyJJcEy.js";const b=`<template>\r
...
`,N=G({name:"AutoProjection"}),z=Object.assign(N,{setup(H){const p=s([{fileName:"新版-@/views/projection/autoProjection/index.vue",rawCode:K,language:"html"},{fileName:"旧版-@/views/projection/autoProjection/indexOld.vue",rawCode:b,language:"html"}]),i=s(null);let o=null;const n=s(0),g=h(()=>n.value>0);let r=[];const f="https://cdn.jsdelivr.net/gh/gisnotes/gisnotes-ol@main/public/data/linzhou_cog.tif",t=new D({sources:[{url:f,nodata:0}]}),l=new Y({url:"https://api.maptiler.com/maps/satellite/{z}/{x}/{y}.jpg?key="+U,tileSize:512,maxZoom:20,crossOrigin:""}),T=()=>n.value++,_=()=>{n.value>0&&n.value--},y=()=>{r.length>0||[t,l].forEach(e=>{r.push(e.on("tileloadstart",T),e.on(["tileloadend","tileloaderror"],_))})},c=()=>{r.length>0&&(r.flat().forEach(e=>C(e)),r=[]),n.value=0};S(()=>{setTimeout(()=>{v()},0)});function v(){t.getView().then(e=>{const{center:d,projection:a}=e;o=new M({target:i.value,layers:[new m({source:l,opacity:.5,style:{exposure:.2}}),new m({source:t,style:{gamma:.7}})],view:new k({center:d,zoom:9,projection:a})})})}return j(()=>{y()}),x(()=>{c()}),A(()=>{c(),o&&(o.setTarget(null),o=null)}),(e,d)=>{const a=L;return R(),I(B,{codeBlocks:u(p)},{default:P(()=>[w(O("div",{class:"auto-projection",ref_key:"mapDivRef",ref:i,"element-loading-background":"rgba(122, 122, 122, 0.8)","element-loading-text":"地图加载中..."},null,512),[[a,u(g)]])]),_:1},8,["codeBlocks"])}}}),Q=E(z,[["__scopeId","data-v-2058994a"]]);export{Q as default};
