import{_ as v,r as s,A as E,F as S,ae as h,af as j,G as x,o as A,m as R,f as w,O as I,h as P,T as O,i as u,H as G}from"./index-DzZiPxEF.js";import{X as L,M,V as k,D as B,u as C}from"./XYZ-CJa539cs.js";import{I as K,r as D,G as Y,M as b,W as p,p as N}from"./index-CJfAduGo.js";import"./index-N60x9Vjo.js";const U=`<template>\r
...
`,z=G({name:"AutoProjection"}),H=Object.assign(z,{setup(F){const m=s([{fileName:"新版-@/views/projection/autoProjection/index.vue",rawCode:K,language:"html"},{fileName:"旧版-@/views/projection/autoProjection/indexOld.vue",rawCode:U,language:"html"}]),i=s(null);let o=null;const n=s(0),f=E(()=>n.value>0);let r=[];D(N);const t=new Y({sources:[{url:"/data/linzhou_cog.tif",nodata:0}]}),l=new L({url:"https://api.maptiler.com/maps/satellite/{z}/{x}/{y}.jpg?key="+b,tileSize:512,maxZoom:20,crossOrigin:""}),g=()=>n.value++,T=()=>{n.value>0&&n.value--},_=()=>{r.length>0||[t,l].forEach(e=>{r.push(e.on("tileloadstart",g),e.on(["tileloadend","tileloaderror"],T))})},c=()=>{r.length>0&&(r.flat().forEach(e=>C(e)),r=[]),n.value=0};S(()=>{setTimeout(()=>{y()},0)});function y(){t.getView().then(e=>{const{center:d,projection:a}=e;o=new M({target:i.value,layers:[new p({source:l,opacity:.5,style:{exposure:.2}}),new p({source:t,style:{gamma:.7}})],view:new k({center:d,zoom:9,projection:a})})})}return h(()=>{_()}),j(()=>{c()}),x(()=>{c(),o&&(o.setTarget(null),o=null)}),(e,d)=>{const a=O;return A(),R(B,{codeBlocks:u(m)},{default:w(()=>[I(P("div",{class:"auto-projection",ref_key:"mapDivRef",ref:i,"element-loading-background":"rgba(122, 122, 122, 0.8)","element-loading-text":"地图加载中..."},null,512),[[a,u(f)]])]),_:1},8,["codeBlocks"])}}}),J=v(H,[["__scopeId","data-v-c917d0c6"]]);export{J as default};
