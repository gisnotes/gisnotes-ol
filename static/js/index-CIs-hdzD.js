import{_ as E,r as s,A as h,F as S,ae as j,af as x,G as A,o as R,m as w,f as I,O as P,h as O,T as G,i as u,H as L}from"./index-CsG9evZo.js";import{X as M,M as k,V as B,D as C,u as K}from"./XYZ-DUDqZuSX.js";import{I as D,G as Y,M as b,W as p}from"./index-DFg-P_Mb.js";import"./index-D6jaisJO.js";const U=`<template>\r
...
`,N=L({name:"AutoProjection"}),z=Object.assign(N,{setup(H){const m=s([{fileName:"新版-@/views/projection/autoProjection/index.vue",rawCode:D,language:"html"},{fileName:"旧版-@/views/projection/autoProjection/indexOld.vue",rawCode:U,language:"html"}]),i=s(null);let o=null;const n=s(0),g=h(()=>n.value>0);let r=[];const f="https://cdn.jsdelivr.net/gh/gisnotes/gisnotes-ol@main/public/data/linzhou_cog.tif",t=new Y({sources:[{url:f,nodata:0}]}),l=new M({url:"https://api.maptiler.com/maps/satellite/{z}/{x}/{y}.jpg?key="+b,tileSize:512,maxZoom:20,crossOrigin:""}),T=()=>n.value++,_=()=>{n.value>0&&n.value--},y=()=>{r.length>0||[t,l].forEach(e=>{r.push(e.on("tileloadstart",T),e.on(["tileloadend","tileloaderror"],_))})},c=()=>{r.length>0&&(r.flat().forEach(e=>K(e)),r=[]),n.value=0};S(()=>{setTimeout(()=>{v()},0)});function v(){t.getView().then(e=>{const{center:d,projection:a}=e;o=new k({target:i.value,layers:[new p({source:l,opacity:.5,style:{exposure:.2}}),new p({source:t,style:{gamma:.7}})],view:new B({center:d,zoom:9,projection:a})})})}return j(()=>{y()}),x(()=>{c()}),A(()=>{c(),o&&(o.setTarget(null),o=null)}),(e,d)=>{const a=G;return R(),w(C,{codeBlocks:u(m)},{default:I(()=>[P(O("div",{class:"auto-projection",ref_key:"mapDivRef",ref:i,"element-loading-background":"rgba(122, 122, 122, 0.8)","element-loading-text":"地图加载中..."},null,512),[[a,u(g)]])]),_:1},8,["codeBlocks"])}}}),W=E(z,[["__scopeId","data-v-2058994a"]]);export{W as default};
